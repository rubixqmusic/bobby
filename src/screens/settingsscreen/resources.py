...
HEADING_TEXT = f"Settings"
BACKGROUND_IMAGE = f"{GRAPHICS_PATH}/backgrounds/title_screen_background.png"
TREES_IMAGE = f"{GRAPHICS_PATH}/backgrounds/title_screen_trees.png"
SETTINGS_SCREEN_MUSIC = f"{MUSIC_PATH}/title_screen.mp3"
SETTINGS_BACKGROUND = f"{GRAPHICS_PATH}/backgrounds/file_select_background.png"
MENU_SELECT_SOUND = f"{SOUNDS_PATH}/menu_select.wav"
MENU_SELECT_SOUND_VOLUME = 0.7
...
MENU_SELECTION_FONT = f"{FONTS_PATH}/{MENU_FONT_BOLD}"
HEADING_FONT = f"{FONTS_PATH}/{MAIN_FONT}"
MENU_SELECTION_SIZE = 16
HEADING_SIZE = 20
MAIN_TEXT_COLOR = f"#fbcb1d"
MENU_SELECTION_COLOR = f"#fe112b"
MENU_DROP_SHADOW_X = 1
MENU_DROP_SHADOW_Y = 1
MENU_DROP_SHADOW_COLOR = f"#000000"

DISPLAY_SETTINGS_TEXT = f"Display Settings"
